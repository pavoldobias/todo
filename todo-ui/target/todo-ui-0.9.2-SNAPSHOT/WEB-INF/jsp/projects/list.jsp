...
<form:form name="projectsForm" modelAttribute="projectsForm" id="projectsForm" action="create.html" method="POST">
   
    <c:set var="projects" value="${projects}" scope="application"/>
	<display:table  class="list" name="${projects}" id="nodes" pagesize="100" requestURI="list">
...
function editSubmit(id, text, abbreviation, description, formMethod){
  	  document.getElementById('projectsForm').action=formMethod+'.html?'+formMethod+'&amp;id='+id+'&amp;name='+text+'';
